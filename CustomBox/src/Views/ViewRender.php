    ...
    public function render(string $content): string
    {
        ...
        <html lang="en">
            <head>
                ...
                <!-- Favicon-->
                <link rel="icon" type="image/x-icon" href="{$this->container->router->pathFor("home")}src/assets/favicon.ico" />
                <!-- Bootstrap icons-->
            ...
            <body>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light w-100">
                    <div class="container px-4 px-lg-5 ">
                        <a class="navbar-brand" href="#!"><img style="width: 40px" src="{$this->container->router->pathFor("home")}src/assets/logo.png"></a>
